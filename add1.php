...
if (isset($_COOKIE['email'])) 
{
    ...
    if (isset($_POST["submit"])) {
        ...
        if (isset($_POST['title'], $_POST['note'], $_POST['nickname'], $_POST['contact'], $_POST['passwd'], $_COOKIE['email'])) {
...
VALUES (" . "'" . $_POST["title"] . '\',' . "'" . $_POST['note'] . '\',\'' . $_POST['nickname'] . '\',\'' . $_POST['contact'] . '\',\'' . $_POST['passwd'] . '\', \'' . $email . '\')';
...
<html>
    ...
    <head>
        ...
        <style>
            ...
            body{background:url('https://api.sunweihu.com/api/bing1/api.php') center no-repeat fixed; background-size:cover}
...
if ($is_email_set == "yes") {
    ...
    $verifyemail = "<div id = 'lst'><span style='color:red'><h1 align='center'>邮箱地址验证已完成，当前邮箱地址：" . $_COOKIE['email'] . "</h1></span></div>";
    ...
    $verifyemail = "<div id = 'lst'> <span style='color:red'><h1 align='center'>请点击右上角验证按钮验证邮箱!</h1></span></div>";
...
<div class="form-group">
  ...
  <button type="submit" class="btn btn-primary  bg-dark text-light">提交</button>
